...
exports.invokeRolesPolicies = function() {
    acl.allow([{
        ...
        allows: [{
            resources: '/api/requester-filters',
            permissions: 'post'
        }, {
            resources: '/api/requester-filters/:requesterId',
            permissions: '*'
        },{
            resources: '/api/requester-filters/clone/:requesterId',
            permissions: '*'
        },{
            resources: '/api/requester-filters/:isPersonal',
            permissions: 'get'
        }]
    }]);
};
