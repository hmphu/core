...
module.exports = function(app) {
    ...
    app.route('/api/auth/:userId/reset').get(users.checkPermisionReset, users.resetPass);
    app.route('/api/auth/reset/:token').get(users.resetPasswordByToken);

    // Setting up the users authentication api
    app.route('/api/auth/signup').post(users.signup);
    app.route('/api/auth/signin').post(users.signin);
    app.route('/api/auth/internal-signin').post(users.internalSignin);
    ...
    app.route('/api/auth/jwt').get(users.signinJwt);
};
