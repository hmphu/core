...
exports.invokeRolesPolicies = function() {
    acl.allow([{
        ...
        allows: [{
            resources: '/api/filter-user-view/count/:view_user_id_',
            permissions: ['get']
        },{
            resources: '/api/filter-user-view/list/:view_user_id_',
            permissions: ['get']
        },{
            resources: '/api/filter-user-view/getDetail/:view_user_id_',
            permissions: ['get']
        }]
    }]);
};
