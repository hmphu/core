 ...
 */
var TicketStatsArchiveSchema = new Schema({
    ed_user_id : {
 ...
 * Pre-save hook
 */
TicketStatsArchiveSchema.pre("save", function(next) {
    var now = +moment.utc();
    if (this.isNew) {
        this.add_time = now;
    }
...
mongoose.model("TicketStatsArchive", TicketStatsArchiveSchema, config.dbTablePrefix.concat("ticket_stats_archive"));
