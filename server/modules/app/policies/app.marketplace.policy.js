...
exports.invokeRolesPolicies = function() {
    acl.allow([{
        ...
        allows: [
            {
                resources: '/api/apps/categories',
                permissions: "get"
            },
            {
                resources: '/api/apps/marketplace',
                permissions: "get"
            },
            {
                resources: '/api/apps/marketplace/featured',
                permissions: "get"
            },
            {
                resources: '/api/apps/marketplace/recommended',
                permissions: "get"
            },
            {
                resources: '/api/apps/marketplace/detail/:marketAppId',
                permissions: "get"
            },
            {
                resources: '/api/apps/marketplace/install/:marketAppId',
                permissions: "post"
            }
        ]
    }]);
