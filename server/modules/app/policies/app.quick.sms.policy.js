...
exports.invokeRolesPolicies = function() {
    acl.allow([{
        roles: [enums.UserRoles.owner, enums.UserRoles.admin, enums.UserRoles.agent], //owner vs admin and agent
        allows: [
            {
                resources: '/api/apps/quick-sms/send',
                permissions: "post"
            },
            {
                resources: '/api/apps/quick-sms/from-file',
                permissions: "post"
            }
        ]
    }]);
