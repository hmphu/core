...
var initGlobalConfigFiles = function (config, assets) {
    ...
    // Setting Globbed rabbitmq files
    config.files.server.rabbitmq = getGlobbedPaths(assets.server.rabbitmq);

    // Setting Globbed policies files
    config.files.server.policies = getGlobbedPaths(assets.server.policies);

    // Setting Globbed events files
    config.files.server.events = getGlobbedPaths(assets.server.events);
};
